...
############### MAIN ##########################
inputDict = {'a': 1,'b': 1,'c': 1,'d': 0,'e': 1}
outputDict = {'F':0,'G':1}
#gateProbabilities = {"A1": 0.96, "A1'": 0.04,"A2": 0.95, "A2'": 0.05,"A3": 0.97, "A3'": 0.03,"X1": 0.98, "X1'": 0.02,"X2": 0.99, "X2'": 0.01}
#gateProbabilities = {"A1": 0.99, "A1'": 0.01,"A2": 0.96, "A2'": 0.04,"A3": 0.97, "A3'": 0.03,"X1": 0.95, "X1'": 0.05,"X2": 0.98, "X2'": 0.02}
gateProbabilities = {"A1": 0.99, "A1'": 0.01,"A2": 0.90, "A2'": 0.10,"A3": 0.80, "A3'": 0.20,"X1": 0.98, "X1'": 0.02,"X2": 0.97, "X2'": 0.03}

(originalEquation, newEquation) = find_min_expression('Polycell_Truth_Table.xlsx', inputDict,outputDict)
